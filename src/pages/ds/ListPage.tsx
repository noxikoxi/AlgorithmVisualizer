...
const ListPage = () => {
    ...
    const elements =  generateRandomNumbers(6, 10, 99);
    ...
    return (
        <>
            ...
            <span className="text-block"><span className="bolded">Access elements:</span> Accessing an element in any type of linked list requires traversing the list, so the time complexity is O(n) for all types.</span>
            <span className="text-block"><span className="bolded">Insert at Beginning:</span> Inserting at the beginning is a constant-time operation (O(1)) for all types of lists, as it only involves updating the head pointer.</span>
            <span className="text-block"><span className="bolded">Insert at End:</span>
            ...
            <span className="text-block"><span className="bolded">Insert at Position:</span> Inserting at a specific position requires traversing the list to reach the desired position, which takes O(n) time for all types of lists.</span>

            <span className="text-block"><span className="bolded">Delete at Beginning:</span> Deleting at the beginning is an O(1) operation for all types of lists, as it only involves updating the head pointer.</span>

            <span className="text-block"><span className="bolded">Delete at End:</span>
                 <ul style ={{listStyleType: "circle", marginLeft: 20, marginTop: 0}}>
            ...
            <p>Circular Doubly Linked List in various programming languages</p>
